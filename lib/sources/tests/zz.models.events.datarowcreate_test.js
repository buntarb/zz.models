...
function setUp( ){
    ...
    event = new zz.models.events.DatarowCreate( message );
}
...
function testConstructor( ){
    ...
    assertTrue(
        ...
        event instanceof zz.models.events.DatarowCreate
    );
}
...
function testPropertyMessage( ){
    ...
    assertTrue(
        ...
        event.message instanceof zz.models.Message
    );
}
...
function testPropertyModel( ){
    ...
    assertTrue(
        ...
        event.model instanceof zz.models.Datarow
    );
}

function testPropertyController( ){
    ...
    if( event.controller ){
        ...
        assertTrue(
            ...
            event.controller instanceof zz.controllers.FEBase
        );
    }
}

function testPropertyElements( ){
